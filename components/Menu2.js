    ...
    <View style={[styles.menu, style]}>
      <View style={styles.iconFeed}>
        <Image
          ...
          contentFit="cover"
          source={require("../assets/iconfeed31.png")}
        />
      ...
      <Property1unselected
        imageDimensions={require("../assets/iconstatistics21.png")}
      ...
      <View style={styles.iconSpaceBlock}>
        <Image
          style={styles.iconFeed1}
          contentFit="cover"
          source={require("../assets/iconstatistics31.png")}
        />
        <Text style={[styles.feed, styles.feedTypo]}>STATISTICS</Text>
      </View>
      <Property1selected
        profileImageId={require("../assets/iconprofile3.png")}
